module.exports = {
  ...
  // draws a USB connector icon (for usb network connections)
  drawUsbIcon: function (display, x0, y0){
    display.oled.fillRect(x0+1, y0, 3, 2, 1, false);
    display.oled.fillRect(x0, y0+2, 5, 3, 1, false);
    display.oled.drawLine(x0+1, y0+5, x0+3, y0+5, 1, false);
    display.oled.drawLine(x0+2, y0+6, x0+2, y0+7, 1, false);
  },
